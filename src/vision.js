...
//          asset_class: 'thai_equity'|'us_equity'|'global_etf'|'hk_equity'|
//                       'thai_fund'|'cash'|'crypto'|'other'|null,
//          symbol: string|null,
//          warnings[] }
...
- "us_equity"    → หุ้นบริษัทสหรัฐรายตัว (AAPL, MSFT, GOOGL, AMZN, META, TSLA, NVDA, BRK.B, JPM, V, JNJ, WMT ฯลฯ)
- "global_etf"   → ETF / Index Fund / ตราสารหนี้ ETF ส่วนใหญ่จดทะเบียนสหรัฐ (SPY, VOO, QQQ, VTI, VT, IVV, SCHD, AGG, BND, GLD, EEM) — สังเกตคำว่า ETF / Index / Trust
